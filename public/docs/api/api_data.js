define({ "api": [
  ...
  },
  {
    ...
    "title": "Profile Picture Update for Android",
    "version": "0.0.1",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "expire_date",
            "description": "<p>User package expire date in unix timestamp</p> "
          }, 
          {
            "group": "Success 200",
            "type": "<p>Integer</p> ",
            "optional": false,
            "field": "is_monthly_enable",
            "description": "<p>User monthly package enable</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>Integer</p> ",
            "optional": false,
            "field": "is_yearly_enable",
            "description": "<p>User yearly package enable</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>String</p> ",
  ...
  },
  {
    ...
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "thumb_image",
            "description": "<p>Template thumb image.</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>Integer</p> ",
      ...
      "examples": [
        {
          "title": "Success-Response:",
          "content": "HTTP/1.1 200 OK\n{\n\"status\":\"SUCCESS\",\n\"result\":\n [{\n     \"category_id\": \"1\",\n     \"category_name\": \"Flora\",\n     \"templates\": [{\n        \"template_id\": 1,\n        \"category_id\": 1,\n        \"template_name\": \"Rose\",\n        \"image_name\":\"f6979db8.png\",\n        \"image_url\": \"http:\\/\\/www.coloring.com\\/images/templates/f6979db8.svg\",\n        \"image_png_url\": \"http:\\/\\/www.coloring.com\\/images/templates/f6979db8.png\",\n        \"thumb_image\": \"http:\\/\\/www.coloring.com\\/images/templates/thumb/f6979db8.png\",\n        \"sub_only\":1 \n     }]\n }],\n \"error\":''\n}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "thumb_image",
            "description": "<p>Temolate thumb image.</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>Integer</p> ",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "thumb_image",
            "description": "<p>Test template thumb image.</p> "
          },
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success-Response:",
          "content": "HTTP/1.1 200 OK\n{\n\"status\":\"SUCCESS\",\n\"result\":\n {\n     \"post\":[{\n       \"post_id\": 1,\n       \"user_id\": 8,\n       \"username\": \"Petter\",\n       \"post_name\": \"New post\",\n       \"template_id\": 1,\n       \"post_image\": \"http:\\/\\/www.coloring.com\\/images/posts/f6979db8.svg\",\n       \"likes\": 5,\n       \"liked\": 1,\n       \"comments\": 8,\n       \"sub_only\": 0,\n       \"is_favourite\": 0,\n       \"post_thumb_image\": \"http:\\/\\/www.coloring.com\\/images/templates/f6979db8.svg\",\n       \"thumb_image\": \"http:\\/\\/www.coloring.com\\/images/templates/thumb/f6979db8.png\",\n       \"created_at\": \"17/03/2017\",\n     }],\n     \"pagination\": \n     {\n       \"total\": 24,\n       \"current_page\": 1,\n       \"last_page\": 3,\n       \"per_page\": 8,\n       \"prev_page_url\": null,\n       \"prev_page_url\": \"http:\\/\\/www.coloring.com\\/api/v1/listArtIdeas?page=2\",\n       \"from\": 1,\n       \"to\": 1,\n     },\n \"error\":''\n}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "post_thumb_image",
            "description": "<p>Post thumb image url.</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>Integer</p> ",
          ...
          },
          {
            ...
            "optional": false,
            "field": "sub_only",
            "description": "<p>sub_only 1-subscribers only 0-free.</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>Array</p> ",
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "Post not exists",
            "description": "<p>Post not exists.</p> "
          },
        ]
      },
      "examples": [
    ...
    "success": {
        ...
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "read",
            "description": "<p>Read status 0-unread,1-read</p> "
          },
    ...
    "success": {
        ...
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "read",
            "description": "<p>Read status 1-read, 0-unread</p> "
          },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "thumb_image",
            "description": "<p>template thumb_image</p> "
          },
           {
            "group": "Success 200",
            "type": "<p>String</p> ",
    ...
    "success": {
        ...
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "is_monthly_enable",
            "description": "<p>User subscribe monthly package</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>Integer</p> ",
            "optional": false,
            "field": "is_yearly_enable",
            "description": "<p>User subscribe yearly package</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>String</p> ",
    ...
    "success": {
        ...
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "is_monthly_enable",
            "description": "<p>User subscribe mintl pulin.</p> "
          },
